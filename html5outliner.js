...
var w = window.open("", "Outline for "+document.title, "toolbar=false,width=230,height=600");
w.document.title="Outline for "+document.title;
w.document.body.appendChild(toc);
